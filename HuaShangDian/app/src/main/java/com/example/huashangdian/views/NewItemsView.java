...
import com.example.huashangdian.NewItemsPackage.AlbumViewAdapter;
...
public class NewItemsView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_items);

        announcements = (TextView) findViewById(R.id.Annocunmnet);

        st = getIntent().getExtras().getString("username");
        announcements.setText("There are " + getNewFlowers().length + " new flowers in stock " + st + " !!! See them below with descriptions");
...
//      the banner at the top of the page
        ...
        adapter = new AlbumViewAdapter(this, flowerList);
